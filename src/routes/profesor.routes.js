...
api.get('/buscarProfesor',[md_autenticacion.Auth],profesorController.buscarProfesor); 
api.get('/buscarProfesorID/:idProfesor',[md_autenticacion.Auth],profesorController.buscarProfesorID);
